...
RepoForm (owner / repo) (NO PROPS / STATE OF FORM)

CommitSection (title / link to repo / commitlist) (GH API response commits, no state)
Commit (Person / Message / Date / Link to commit) (commit object)
CommitList (Commit) (array of commit objects)
